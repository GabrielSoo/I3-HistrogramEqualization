    ...
    imageproc.kuwahara = function(inputData, outputData, size) {
        ...
        for (var y = 0; y < inputData.height; y++) {
            for (var x = 0; x < inputData.width; x++) {
                ...
                var regionA = regionStat(x - index, y - index, size, inputData);
                var regionB = regionStat(x + index, y - index, size, inputData);
                var regionC = regionStat(x - index, y + index, size, inputData);
                var regionD = regionStat(x + index, y + index, size, inputData);
