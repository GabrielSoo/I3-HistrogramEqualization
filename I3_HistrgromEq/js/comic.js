(function(imageproc) {
    ...
    imageproc.comicColor = function(inputData, outputData, saturation) {
        ...
        for (var i = 0; i < inputData.data.length; i += 4) {
            ...
            hsv.s = Math.min(hsv.s * saturation, 1);
            ...
            var closestColor = 0;
            var minDistance = Math.hypot(r - palette[0][0], g - palette[0][1], b - palette[0][2])
            ...
            r = palette[closestColor][0];
            g = palette[closestColor][1];
            b = palette[closestColor][2];
